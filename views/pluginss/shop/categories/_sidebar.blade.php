...
@auth
    <div class="d-grid gap-2 mb-4">
        ...
        <a href="{{ route('shop.cart.index') }}" class="cursorAnim btn btn-primary btn-block">
...
@if($goal !== false)
    <div class="card mb-4 w-100 borderType maTop">
        <div class="card-header d-flex gap-1 justify-content-center py-1 mt-2">
        ...
        <div class="card-body">
            <div class="progress mb-1 bg-myBackground">
